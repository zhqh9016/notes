...
public class ApplicationDO extends BaseModel {
  ...
  public void setDeputyIdType(String deputyIdType) {
    this.deputyIdType = deputyIdType == null ? null : deputyIdType.trim();
  }
  ...
  public void setDeputyAddress(String deputyAddress) {
    this.deputyAddress = deputyAddress == null ? null : deputyAddress.trim();
  }
  ...
  public void setIsTaskDeadline(String isTaskDeadline) {
    this.isTaskDeadline = isTaskDeadline == null ? null : isTaskDeadline.trim();
  }
  ...
  public void setDiseaseCause(String diseaseCause) {
    this.diseaseCause = diseaseCause == null ? null : diseaseCause.trim();
  }
