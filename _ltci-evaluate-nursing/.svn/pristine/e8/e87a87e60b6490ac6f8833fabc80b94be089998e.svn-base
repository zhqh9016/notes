...
public interface TodoListServerClient {
  ...
  @RequestMapping(method = RequestMethod.POST, value = "/api/v1/todoListByBusinessType")
  public ResultDTO getTodoListByBusinessType(
      @RequestParam(value = "businessType") String businessType,
      @RequestParam(value = "createdOrg") String createdOrg);
}
