...
public class XssShieldUtil {
  ...
  public static void main(String[] args) {
    ...
    String value = null;
    value =
        XssShieldUtil.stripXss("<script language=text/javascript>alert(document.cookie);</script>");
    ...
    value = XssShieldUtil.stripXss("\" ' (");
    System.out.println("type-14: " + value);

    value = XssShieldUtil.stripXss("'or '1'='1 '");
    System.out.println("type-15: " + value);

    value = XssShieldUtil.stripXss("222222\"22,222");
    System.out.println("type-16: " + value);

    value = XssShieldUtil.stripXss("{\"name\":'adsf','sex':'asdfd'}");
