...
public class PatrolTaskDetailSpecialDO extends BaseModel {
  ...
  private String preevaluateDate;
  ...
  public String getPreevaluateDate() {
    return preevaluateDate;
  }

  public void setPreevaluateDate(String preevaluateDate) {
